...
goto endofperl
@rem ';
#!C:\Users\Admin\Desktop\All-in-One_v1.9\xampp\perl\bin\perl.EXE -w
#line 15
# ====================================================================
#
...
my $CP    = 'C:\Users\Admin\Desktop\All-in-One_v1.9\xampp\perl\bin\perl.EXE -MExtUtils::Command -e cp';
my $CHMOD = 'C:\Users\Admin\Desktop\All-in-One_v1.9\xampp\perl\bin\perl.EXE -MExtUtils::Command -e chmod';
my $RM_F  = 'C:\Users\Admin\Desktop\All-in-One_v1.9\xampp\perl\bin\perl.EXE -MExtUtils::Command -e rm_f';
my $TOUCH = 'C:\Users\Admin\Desktop\All-in-One_v1.9\xampp\perl\bin\perl.EXE -MExtUtils::Command -e touch';
