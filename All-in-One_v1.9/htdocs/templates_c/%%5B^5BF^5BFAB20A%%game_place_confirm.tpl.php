<?php /* Smarty version 2.6.14, created on 2022-12-24 00:48:39
...
<?php if ($this->_tpl_vars['type'] == 'attack'): ?>
	<h2><?php echo $this->_tpl_vars['lang']->get('attack'); ?>
</h2>
<?php else: ?>
	<h2><?php echo $this->_tpl_vars['lang']->get('support'); ?>
</h2>
<?php endif; ?>
...
">
	...
	<table class="vis" width="300">
		<tr><th colspan="2"><?php echo $this->_tpl_vars['lang']->get('command'); ?>
</th></tr>
...
:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['unit_runtime'])) ? $this->_run_mod_handler('format_time', true, $_tmp) : format_time($_tmp)); ?>
</td></tr>
		<tr><td><?php echo $this->_tpl_vars['lang']->get('arrival'); ?>
:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['arrival'])) ? $this->_run_mod_handler('format_date', true, $_tmp) : format_date($_tmp)); ?>
</td></tr>
	</table>
	<br>
	<table class="vis">
...
">
	<?php endforeach; endif; unset($_from); ?>
	    ...
	    <table class="vis">
	        <tr>
	            <th><?php echo $this->_tpl_vars['lang']->get('attack_building'); ?>
:</th>
	            <td>
