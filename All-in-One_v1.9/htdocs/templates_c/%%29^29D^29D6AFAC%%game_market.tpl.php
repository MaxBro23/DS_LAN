...
<table>
	<tr>
		<td>
			<img src="<?php echo $this->_tpl_vars['cl_builds']->getGraphic('market',$this->_tpl_vars['village']['market']); ?>
" title="Marktplatz" alt="" />
		</td>
		<td>
			<h2><?php echo $this->_tpl_vars['lang']->get('market'); ?>
 (<?php echo ((is_array($_tmp=$this->_tpl_vars['village']['market'])) ? $this->_run_mod_handler('stage', true, $_tmp) : stage($_tmp)); ?>
)</h2>
