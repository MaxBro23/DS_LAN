...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stage', 'game_place.tpl', 7, false),)), $this); ?>
<table>
	<tr>
		<td>
		...
		<td>
			<h2>Versammlungsplatz (<?php echo ((is_array($_tmp=$this->_tpl_vars['village']['place'])) ? $this->_run_mod_handler('stage', true, $_tmp) : stage($_tmp)); ?>
)</h2>
...
"><?php echo $this->_tpl_vars['f_name']; ?>
			...
			<?php endif; ?>
		<?php endforeach; endif; unset($_from); ?><tr><td><a href="all_units.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
">Alle Einheiten</a></td></tr>
