...
<table class="vis">
<tr><th width="60"><?php echo $this->_tpl_vars['lang']->grab('ranking','rank'); ?>
</th><th width="180"><?php echo $this->_tpl_vars['lang']->grab('ranking','name'); ?>
</th><th width="100"><?php echo $this->_tpl_vars['lang']->grab('ranking','tribe'); ?>
</th>
<th width="60"><?php echo $this->_tpl_vars['lang']->grab('ranking','points'); ?>
</th><th><?php echo $this->_tpl_vars['lang']->grab('ranking','villages'); ?>
</th><th><?php echo $this->_tpl_vars['lang']->grab('ranking','average_village'); ?>
</th></tr>
