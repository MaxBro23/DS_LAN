...
"> [<?php echo $this->_sections['countpage']['index']; ?>
		...
		<?php endif; ?>
		<tr>
			<th><?php echo $this->_tpl_vars['lang']->get('subject'); ?>
</th>
			<th width="140"><?php echo $this->_tpl_vars['lang']->get('received'); ?>
</th>
		</tr>
...
"><?php echo $this->_tpl_vars['reports'][$this->_tpl_vars['key']]['title']; ?>
			...
			<tr>
				<th><input name="all" type="checkbox" onclick="selectAll(this.form, this.checked)" /> <?php echo $this->_tpl_vars['lang']->get('sel_all'); ?>
 </th>
				<th></th>
			</tr>
			</table>
