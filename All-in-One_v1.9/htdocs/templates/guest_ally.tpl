...
<table class="vis">
<tr><td class="selected" width="100"><a href="/guest.php?screen=ranking&amp;mode=ally">Stämme</a></td></tr>
<tr><td width="100"><a href="/guest.php?screen=ranking&amp;mode=player">Spieler</a></td></tr>
</table>

</td><td valign="top"><table class="vis">
<tr><th width="60">Rang</th><th width="70">Name</th>

<th width="60">Gesamtpunkte</th><th>Mitglieder</th><th>Punkteschnitt<br />Spieler</th><th>D&ouml;rfer</th><th>Punkteschnitt<br />Dorf</th></tr>
