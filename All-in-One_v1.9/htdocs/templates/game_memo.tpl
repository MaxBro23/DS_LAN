...
<noscript>
	...
	<tr><td><input type="submit" value="{$lang->get("save")}" /></td><td align="right"></td></tr>
	</table>
	</form>
</noscript>
...
<tr id="submit_row" style="display:none"><td><input type="submit" value="{$lang->get("save")}" /></td><td align="right"></td></tr>
</table>
</form>
</div>
<script type="text/javascript">
