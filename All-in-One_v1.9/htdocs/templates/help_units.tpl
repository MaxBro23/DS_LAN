<h3>{$lang->get("units")}</h3>

<table class="vis" width="100%">
<tr align="right"><th align="left">{$lang->get("unit")}</th><th><img src="graphic/holz.png" title="Holz" alt="" /></th><th><img src="graphic/lehm.png" title="Lehm" alt="" /></th><th><img src="graphic/eisen.png" title="Eisen" alt="" /></th><th><img src="graphic/face.png" title="Arbeiter" alt="" /></th>
