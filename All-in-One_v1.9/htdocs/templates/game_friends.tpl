...
if ($do=="cancel_buddy"){
   ...
   if ($control_number==1){
      ...
      if ($control_number_block==0) {
         ...
         $title="Die Freundesanfrage von $name_player wurde zurückgezogen";
...
if ($do=="reject_buddy"){
   ...
   if ($control_number==1){
      ...
      if ($control_number_block==0) {
         ...
         $title="$name_player wurde nicht hinzugefügt";
...
if ($do=="add_buddy"){
   ...
   if ($nr_result==1){   
      ...
      if ($id_newfriend<>$id_player){
         ...
         header("Location: game.php?village=$id_village&screen=friends&error=Du kannst diesen Spieler nicht hinzufügen");
      }
...
denen du sehr gut vertrauen kannst, da diese deinen Onlinestatus sehen können. Dieser wäre eine zu wertvolle Information für deine Feinde.</b></p> 
...
<tr> 
	...
	<td>{php}if ($online=='y') { echo '<center><img src="graphic/user_online.gif" alt="online" title="online"></center>'; } elseif ($online=='n') { echo '<center><img src="graphic/user_offline.gif" alt="offline" title="offline"></center>';}{/php}</td>
        <td><a href="game.php?village={$village.id}&amp;screen=friends&amp;action=delete_buddy&amp;buddy_id={php}echo $value{/php}" onclick="return confirm('Bist du sicher das du diesen Spieler von deiner Freundesliste entfernen willst?')">Löschen</a></td> 
</tr> 
{php}}{/php}
</table> 
{php}}{/php}
...
<tr> 
	...
	<td><a href="game.php?village={$village.id}&amp;screen=friends&amp;action=cancel_buddy&amp;buddy_id={php}echo $value{/php}" onclick="return confirm('Bist du sicher das du diesen Freund löschen willst?')">Freunde l&ouml;schen</a></td> 
</tr> 
{php}}{/php}
</table> 
{php}}{/php}
...
<tr> 
	...
	<td><a href="game.php?village={$village.id}&amp;screen=friends&amp;action=approve_buddy&amp;buddy_id={php}echo $value{/php}" onclick="return confirm('Bist du sicher das du diese Freundesanfrage annehmen möchtest?')">Annehmen</a></td> 
	<td><a href="game.php?village={$village.id}&amp;screen=friends&amp;action=reject_buddy&amp;buddy_id={php}echo $value{/php}" onclick="return confirm('Bist du sicher das du diese Freundanfrage ablehnen möchtest?')">Ablehnen</a></td> 
</tr> 
{php}}{/php}
</table> 
{php}}{/php}
