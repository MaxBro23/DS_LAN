...
<tr><td width="100">Name:</td><td>{$guestAllyName}</td></tr>

<tr><td>Tag:</td><td>{$guestAllyShort}</td></tr>
<tr><td>Mitgliederanzahl:</td><td>{$guestAllyMembers}</td></tr>
<tr><td>Gesamtpunkte:</td><td>{$guestAllyPoints}</td></tr>

<tr><td>Punktedurchschnitt:</td><td>{$guestAllyPointsAverage}</td></tr>
...
<tr><td colspan="2" align="center"><a href="/guest.php?screen=info_member&id={$guestAllyId}">Mitglieder</a></td></tr>
