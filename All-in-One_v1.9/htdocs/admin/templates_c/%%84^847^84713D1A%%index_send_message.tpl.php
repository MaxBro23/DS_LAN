<?php /* Smarty version 2.6.14, created on 2010-11-20 20:51:52
...
if (strlen($nume) <= 2)
{
$err1='<tr><td colspan="2"><div class="error">The name must contain 3 characters!</div></td></tr>';
}
else
{
$err1='';
...
if (strlen($subiect) <= 1)
{
$err2="<tr><td colspan='2'><div class='error'>You don't have subject!</div></td></tr>";
}
else
{
$err2='';
...
$err3='<tr><td colspan="2"><div class="error">This name does not exist!</div></td></tr>';
...
if ($err1 == '' && $err2 == '' && $err3 == '')
  ...
  $sql4 = "INSERT INTO `mail_in`
                    ...
                    VALUES ('-1','Owner','".$id."','".$nume."','".$subiect."','".$text."','0','0','-1','".$timp."')";
					mysql_query("UPDATE users SET new_mail = '1' WHERE username = '$nume'");
            $res4 = mysql_query($sql4) or die(mysql_error());
	
	$succes = '<tr><td colspan="2"><font color="green"><strong>The message has bee send!</strong></font></td></tr>';
  }
...
<label>
<tr>
  <td>Player name:</td><td><input type="text" name="nume" /></td></tr>
  </label>
  <br />
  <label><tr>
  <td>Subject:</td>
...
<br />
<tr>
 <td colspan="2"><textarea id="message" rows="16" cols="80" name="text"></textarea></td>
 </tr>
  <tr>
