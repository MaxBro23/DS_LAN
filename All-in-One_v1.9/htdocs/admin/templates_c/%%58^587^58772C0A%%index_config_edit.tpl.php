<?php /* Smarty version 2.6.14, created on 2010-11-26 14:58:12
...
">
			...
			<option value="c" <?php if ($this->_tpl_vars['cfg']['default'] == 'c'): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['cfg']['c']; ?>
</option>
		</select>
	<?php endif; ?>
