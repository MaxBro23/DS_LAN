...
$my_user_folder="../../graphic/unit_big/";
$my_user_folder2="../../graphic/unit/";
...
if ($_GET["action"] == "install")
{
	...
	echo "<a href=\"../index.php?screen=create_new_units\">Zur&uuml;ck</a>";
}
...
if ($_GET["action"] == "edit")
{
	...
	mysql_query("ALTER TABLE `villages` ADD `all_unit_".$_POST['unit_name']."` INT( 6 ) NULL DEFAULT '0';") or die(mysql_error());
        ...
        move_uploaded_file($_FILES['userfile']['tmp_name'], $my_user_folder . $_FILES['userfile']['name']);
        move_uploaded_file($_FILES['userfile2']['tmp_name'], $my_user_folder2 . 'unit_' . $_FILES['userfile2']['name']);

	echo "Die Einheit wurde angelegt.<br>";
	echo "<a href=\"http://localhost/admin/index.php?screen=create_new_units\">Zur&uuml;ck</a>";
